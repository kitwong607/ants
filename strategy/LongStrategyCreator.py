...
class LongStrategyCreator(FutureAbstractStrategy):
    ...
    OPTIMIZATION_PARAMETER = {
        ...
        "signalId_1": {"name": "signalId_1", "value": 113, "min": 1, "max": 184, "step": 1},
        "signalId_2": {"name": "signalId_2", "value": -1, "min": 1, "max": 184, "step": 1},
        "signalId_3": {"name": "signalId_3", "value": -1, "min": 1, "max": 184, "step": 1},
        "rangeFilterId": {"name": "rangeFilterId", "value": 1, "min": 1, "max": 6, "step": 1}
    }

    STRATEGY_NAME = "Long Strategy Creator"
    STRATEGY_SLUG = "LongStrategyCreator"
    VERSION = "1.0"
    ...
    def SetupSignal(self, signalId):
        ...
        #signal = XLowerMaxY(self, "close", 0, "openD", 5)
        #signal = XHigherY(self, "close", 0, "openD", 1)
        #signal = XHigherMaxY(self, "close", 0 , "close", 50)
        #signal = XLowerMaxY(self, "close", 0 , "close", 50)
        #signal = XHigherMinY(self, "close", 0 , "close", 50)
        #signal = XLowerMinY(self, "close", 0 , "close", 50)
        #signal = XHigherMinYZ(self, "close", 0 , "close", 50, "lowD", 3)
        #signal = XLowerMinYZ(self, "close", 0 , "close", 50, "lowD", 3)
        #signal = AverageXHigherY(self, "close", 50, "openD", 1)
        #signal = AverageXLowerY(self, "close", 50, "openD", 1)
        signal = AverageXHigherMaxY(self, "close", 50, "openD", 1)
        return
